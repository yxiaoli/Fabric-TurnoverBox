...
return{
	...
	add_box: function(req, res){
		console.log("submit recording of a box insert: ");

		var array = req.params.tuna.split("-");
		console.log(array);

		var key = array[1]
		var star_time = array[1]
		var end_time = array[2]
		var type = array[4]
		var owner = array[0]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        fcn: 'addBox',
		        args: [key, owner, star_time, end_time, type],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
